...
~~[Abusix Mail Intelligence](https://abusix.org/)~~| ~~Check if a netblock or IP address is in the Abusix Mail Intelligence blacklist.~~                                             | ~~Tiered API~~ | Appears Defunct (18/1/26)                                       |
...
~~[BGPView](https://bgpview.io/)~~| ~~Obtain network information from BGPView API.~~                                                                                | ~~Free API~~     | Appears Defunct as of 18/1/26                                   
...
~~[Bitcoin Who's Who](https://bitcoinwhoswho.com/)~~| ~~Check for Bitcoin addresses against the Bitcoin Who's Who database of suspect/malicious addresses.~~                          | Appears Defunct as of 18/1/26         |                                                                 | Tiered API     
...
~~[CallerName](http://callername.com/)~~| ~~Lookup US phone number location and reputation information.~~                                                                 | Free API       | Appears Defunct as of 18/1/26                                   |
...
~~[Crobat API](https://sonar.omnisint.io/)~~| ~~Search Crobat API for subdomains.~~                                                                                           | Free API  | Appears defunct as of 18/1/2026                                 |     
...
~~[CRXcavator](https://crxcavator.io/)~~| ~~Search CRXcavator for Chrome extensions.~~                                                                                    | Free API    | Appears defunct as of 18/1/2026                                 |        
Custom Threat Feed| Check if a host/domain, netblock, ASN or IP is malicious according to your custom feed.                                         | Internal       
[CyberCrime-Tracker.net](https://cybercrime-tracker.net/)| Check if a host/domain or IP address is malicious according to CyberCrime-Tracker.net.                                          | Free API    | Most recent data is 30-12-2023                                  |   
...
~~[EmailCrawlr](https://emailcrawlr.com/)~~| ~~Search EmailCrawlr for email addresses and phone numbers associated with a domain.~~                                          | Tiered API  | Appears defunct as of 18/1/2026                                 |   
...
File Metadata Extractor| Extracts metadata from documents and images.                                                                                    | Internal       
...
~~[F-Secure Riddler.io](https://riddler.io/)~~| ~~Obtain network information from F-Secure Riddler.io API.~~                                                                    | Commercial API | Appears defunct as of 18/1/2026                                 |
...
~~[Mnemonic PassiveDNS](https://www.mnemonic.no)~~| ~~Obtain Passive DNS information from PassiveDNS.mnemonic.no.~~                                                                 | Free API       | Appears defunct as of 18/1/2026                                 |
~~[multiproxy.org Open Proxies](https://multiproxy.org/)~~| ~~Check if an IP address is an open proxy according to multiproxy.org open proxy list.~~                                        | Free API       | Appears defunct as of 18/1/2026                                 |
...
~~[Onion.link](https://onion.link/)~~| ~~Search Tor 'Onion City' search engine for mentions of the target domain using Google Custom Search.~~                         | Free API      | Appears defunct as of 18/1/2026                                 | 
~~[Onionsearchengine.com](https://as.onionsearchengine.com)~~| ~~Search Tor onionsearchengine.com for mentions of the target domain. ~~                                                        | Free API       | Appears defunct as of 18/1/2026                                 | 
...
~~[Psbdmp](https://psbdmp.cc/)~~| ~~Check psbdmp.cc (PasteBin Dump) for potentially hacked e-mails and domains. ~~                                                | Free API     | Will cease operations on 02/09/2026                             |  
[Pulsedive](https://pulsedive.com/)| Obtain information from Pulsedive's API.                                                                                        | Tiered API     
~~[PunkSpider](https://punkspider.io/)~~| ~~Check the QOMPLX punkspider.io service to see if the target is listed as vulnerable. ~~                                       | Free API       | Service currently suspended; browser extension may work         |
...
~~[RiskIQ](https://community.riskiq.com/)~~| ~~Obtain information from RiskIQ's (formerly PassiveTotal) Passive DNS and Passive SSL databases.~~                             | Tiered API     | Appears defunct as of 18/1/2026                                 |
[Robtex](https://www.robtex.com/)| Search Robtex.com for hosts sharing the same IP.                                                                                | Free API       
~~[searchcode](https://searchcode.com/)~~| ~~Search searchcode for code repositories mentioning the target domain.~~                                                       | Free API       | Defunct as of 18/1/2026; ceased  operations on 2025/08/28       |
...
~~[SORBS](http://www.sorbs.net/)~~| ~~Query the SORBS database for open relays, open proxies, vulnerable servers, etc.~~                                            | Free API   | Appears defunct as of 18/1/2026                                 |    
...
~~[Sublist3r PassiveDNS](https://api.sublist3r.com)~~| ~~Passive subdomain enumeration using Sublist3r's API~~                                                                         | Free API     | Defunct as of 19/1/2026                                         |  
...
~~Threat Jammer~~| ~~Check if an IP address is malicious according to ThreatJammer.com~~                                                           | Tiered API    | Domain is spamjacked as of 19/1/2026  (removed link for safety) | 
~~[ThreatCrowd](https://www.threatcrowd.org)~~| ~~Obtain information from ThreatCrowd about identified IP addresses, domains and e-mail addresses.~~                            | Free API       | Appears defunct as of 19/1/2026                                 |
...
~~[Trashpanda](https://got-hacked.wtf)~~| ~~Queries Trashpanda to gather intelligence about mentions of target in pastesites~~                                            | Tiered API     | Defunct as of 19/1/2026                                         |
...
~~[ZoneFile.io](https://zonefiles.io)~~| ~~Search ZoneFiles.io Domain query API for domain information.~~                                                                | Tiered API    | Appears defunct as of 19/1/2026                                 | 
